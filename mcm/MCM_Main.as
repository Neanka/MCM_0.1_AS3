		...
		private function itemPressedHandler(e: Event): void
		{
			switch (MainMenu.MainPanel_mc.List_mc.selectedEntry.index)
			{
				case 100:
					...
					MainMenu.BackgroundAndBrackets_mc.DLCPanelBrackets_mc.getChildAt(0).visible = false;
					MainMenu.BackgroundAndBrackets_mc.DLCPanelBrackets_mc.addChild(mcmMenu);
